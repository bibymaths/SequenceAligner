...
def build_summary_data(
    ...
    summary['input_files'] = dict(input_files)
    summary['sequence_ids'] = list(sequence_ids)
    summary['sequence_lengths'] = list(sequence_lengths)
    summary['dp_shapes'] = {k: list(v) for k, v in dp_shapes.items()}
    summary['stats_metadata'] = stats_metadata
    # Top blocks
    summary['top_blocks'] = {}
